...
# # 4/5/21 - 3-phase fit to G145203_1939.

# ## Phases: 
#1(r) phase1_nlive = 200, phase1_tolerance = 0.5
#2(white) phase2_nlive = 200 (source mask), phase2_tolerance = 0.25
#3(white) phase3_nlive = 300, phase3_tolerance = 0.25, facc=0.3 for all phases, use effective radius from GAMA DR3 Sersic Photometry catalog (including errors) and upper limit (effective radius + error), 4 position, threshold=1.0
# 
...
# set positions
pos = np.genfromtxt(f'{object_folder}{links_id}_white_positions_grid.csv', delimiter=',', skip_header=0)
