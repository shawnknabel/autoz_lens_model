...
# # 3/19/21 - 3-phase fit to G3891172_3056.

### Only r band images in this one.
...
#)
# set r with the same positions for phase 3
...
# einstein radius
lens.mass.einstein_radius = af.GaussianPrior(mean=einstein_radius, sigma=0.5*einstein_radius, lower_limit=0.0) 
