...
# # 3/10/21 - Experiment 4 (using revised preprocessing)

# ## 4 : phase1_nlive = 200, phase1_tolerance = 0.5, phase2_nlive = 500, phase2_tolerance = 0.25, 4 Positions, Positions threshold = 1.0, use effective radius from GAMA DR3 Sersic Photometry catalog with sigma the observed error and upper limit (effective radius + error 1.3435+0.1146=1.4581), smaller mask (effective radius) centered at (0.075, -0.075), fix lens light bulge profile in second phase. Source R_E (0->10*lens.inensity)
# 
...
phase1 = al.PhaseImaging(
    search=af.DynestyStatic(
        ...
        evidence_tolerance=2.0, walks = 10
    ),
    settings=settings,
...
lens.bulge.effective_radius.upper_limit=re_g+re_g_err
