...
# # 3/5/21 - Second fit to G3629152_1933.

# ## Experiment 2 : phase1_nlive = 200, phase1_tolerance = 0.5, phase2_nlive = 300, phase2_tolerance = 0.25, use effective radius from GAMA DR3 Sersic Photometry catalog (including errors) and upper limit (effective radius + error), normal mask, Source R_E (0->10*lens.inensity), 2 position, threshold=1.0
# 
