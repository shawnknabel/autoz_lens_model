...
# # 3/5/21 - Experiment 3 to G3629152_1933. Three-phase.

# ## Experiment 3 : phase1_nlive = 200, phase1_tolerance = 0.5, phase2_nlive = 200 (source mask), phase2_nlive = 300, phase2_tolerance = 0.25, use effective radius from GAMA DR3 Sersic Photometry catalog (including errors) and upper limit (effective radius + error), Source R_E (0->10*lens.inensity), 2 position, threshold=1.0
# 
...
source_mask = al.Mask2D.circular_annular(
    shape_native=imaging_r.shape_native, pixel_scales=imaging_r.pixel_scales, sub_size=2, outer_radius=3.5, inner_radius=1.5,
...
phase3 = al.PhaseImaging(
    search=af.DynestyStatic(
        path_prefix=f'{output_folder}', name=f"experiment_{experiment_number}_phase3_fit_{datetime}", n_live_points=300,
